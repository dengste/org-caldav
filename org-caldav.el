    ...
    (org-map-entries
     (lambda ()
       (let ((entry (org-element-at-point)))
	     ...
	     (unless (and org-caldav-select-tags (not (seq-intersection org-caldav-select-tags (org-get-tags entry))))
	       (unless (and org-caldav-exclude-tags (seq-intersection org-caldav-exclude-tags (org-get-tags entry)))
		 (org-id-get-create)
